...
const footerLinks = {
  Features: [
    { label: "AI Clipping", href: "#features" },
    { label: "Auto Captions", href: "#features" },
    { label: "Face Tracking", href: "#features" },
    { label: "Smart Reframing", href: "#features" },
  ],
  Pricing: [
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 py-12 sm:py-16 md:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-muted-foreground">
              Turn long YouTube videos into viral short clips with AI. Create
              scroll-stopping content in seconds.
            </p>
            <div className="mt-6 flex items-center gap-3">
              <a
                href="#"
                aria-label="Twitter"
                className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/[0.04] text-muted-foreground transition-colors hover:bg-white/[0.08] hover:text-foreground"
              >
                <svg
                  className="h-4 w-4"
                  fill="currentColor"
        ...
        <div className="flex flex-col items-center justify-between gap-4 border-t border-white/[0.06] py-6 sm:flex-row">
          <p className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} ClipMaker AI. All rights reserved.
          </p>
